...
const SAMPLE_PDF_PATH = path.join(__dirname, '../../samples/s201-sanmarcos-framing.pdf');
...
router.get('/projects/:id/pdf', async (req, res) => {
  if (isSampleProject(req.params.id)) {
    ...
    res.setHeader('Content-Disposition', 'inline; filename="s201-sanmarcos-framing.pdf"');
